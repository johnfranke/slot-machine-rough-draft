...
var App = (_temp = _class = function (_React$Component) {
 ...
 _createClass(App, [{
   ...
   value: function render() {
     ...
     if (winner !== null) {
       repeatButton = React.createElement(RepeatButton, { onClick: this.handleClick });
     }
     ...
     return React.createElement(
       ...
       React.createElement(
         ...
         React.createElement(
           'span',
           null,
           winner === null ? 'Spinning!' : winner ? 'Pure skill!' : getLoser()
         )
       ),
       React.createElement(
         'div',
         { className: 'spinner-container' },
         React.createElement(Spinner, { onFinish: this.finishHandler, ref: function ref(child) {
 ...
 return App;
}(React.Component), _class.loser = ['Lost 1', 'Lost 2', 'Lost 3!'], _class.matches = [], _temp);
var Spinner = (_temp2 = _class2 = function (_React$Component2) {
 ...
 function Spinner(props) {
   ...
   var _this3 = _possibleConstructorReturn(this, (Spinner.__proto__ || Object.getPrototypeOf(Spinner)).call(this, props));
